...
#include "../../source/bitree.c"
#include "../../source/traverse.c"
...
int main(int argc, char const *argv[]) {
    ...
    *****************************************************************************/
    ...
    fprintf(stdout, "Teseting bitree_is_leaf...Value=%d (0=OK)\n", i);

    i = bitree_is_leaf(bitree_left((bitree_root(&tree))));
    fprintf(stdout, "Teseting bitree_is_leaf...Value=%d (0=OK)\n", i);

    i = bitree_is_leaf(bitree_left(bitree_left((bitree_root(&tree)))));
    fprintf(stdout, "Teseting bitree_is_leaf...Value=%d (1=OK)\n", i);
